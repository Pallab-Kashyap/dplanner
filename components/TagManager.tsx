...
export default function TagManager({ onClose, inline = false }: TagManagerProps) {
  ...
  const content = (
    <>
      ...
      {/* Tag list */}
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem", marginBottom: "1rem", maxHeight: inline ? 200 : 240, overflowY: "auto" }}>
        {tags.map((tag) => (
